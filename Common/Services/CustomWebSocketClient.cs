...
namespace Common.Services
{
    public class CustomWebSocketClient
    {
        ...
        public Task SendAsync<T>(string command, T message) where T : ChatMessage
        {
        ...
        private void Handle(byte[] buffer)
        {
            ...
            {
                handler.Value.Item2(JsonSerializer.Deserialize(serializedMessage, handler.Value.Item1));
            }
        }
